...
#Nome de arquivos  de peso e resultados associados a este modelo
file1 = 'primavera06112019_90_10.h5'
file2 = 'primavera06112019_90_10.txt'
...
base = pd.read_csv('primavera-treinamento90.csv')
file_teste = 'primavera-teste90.csv'
...
# Utilizar 90 dias anteriores para prever um valor 
    ...
    for c in range(len(configuracoes)):
        ...
        for epoca in epocas:
            for batch in batchSizes:
                ...
                plt.savefig('Petr4.Close.'+str(len(configuracao))+'Cam.'+str(configuracao[0].neuronio)+'Neu.'+nome_tipo+'Tipo.Temp.'+nome+'.Ant.'+str(anterior)+'.png')
                #plt.show()
                plt.close()
